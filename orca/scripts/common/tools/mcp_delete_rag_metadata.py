...
TOOL_NAME = "delete_rag_metadata"



async def main():
    parser = build_argparser(TOOL_NAME, None, "Delete a metadata entry from a RAG file by its full resource name.", "Example input CSV:\n    name\n    ...\n\nExample output CSV:\n    result_field1,result_field2,...\n    value1,value2,...\n")
