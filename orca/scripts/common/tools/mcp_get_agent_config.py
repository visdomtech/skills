#!/usr/bin/env python3
"""Get the AgentConfig for an orcaagents agent by ID. Returns systemPrompt, model, enabled, includeThoughts, and thinkingBudget.
...
async def main():
    parser = build_argparser(TOOL_NAME, None, "Get the AgentConfig for an orcaagents agent by ID. Returns systemPrompt, model, enabled, includeThoughts, and thinkingBudget.", "Example input CSV:\n    agentId\n    ...\n\nExample output CSV:\n    result_field1,result_field2,...\n    value1,value2,...\n")
