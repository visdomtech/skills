...
Example input CSV:
    changeType?(optional),jurisdiction?(optional),sinceDate
    ...,...,...
...
TOOL_NAME = "get_latest_law_changes"



async def main():
    parser = build_argparser(TOOL_NAME, None, "Get latest law changes from Firestore since a given date. Only changes with revised_enactment_date >= sinceDate are returned.", "Example input CSV:\n    changeType?(optional),jurisdiction?(optional),sinceDate\n    ...,...,...\n\nExample output CSV:\n    result_field1,result_field2,...\n    value1,value2,...\n")
