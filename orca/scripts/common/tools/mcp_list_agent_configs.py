#!/usr/bin/env python3
"""List all AgentConfig documents in Firestore. Returns the same fields as get_agent_config for every agent.
...
TOOL_NAME = "list_agent_configs"



async def main():
    parser = build_argparser(TOOL_NAME, None, "List all AgentConfig documents in Firestore. Returns the same fields as get_agent_config for every agent.", "Example input CSV:\n    index\n    1\n\nExample output CSV:\n    result_field1,result_field2,...\n    value1,value2,...\n")
