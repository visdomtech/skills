...
TOOL_NAME = "set_rag_file_name"



async def main():
    parser = build_argparser(TOOL_NAME, None, "Set the Vertex AI RAG file name for a document and record the processed timestamp.", "Example input CSV:\n    entries,workspaceId\n    ...,...\n\nExample output CSV:\n    result_field1,result_field2,...\n    value1,value2,...\n")
