#!/usr/bin/env python3
"""List all object names under a GCS bucket path (e.g. gs://bucket/prefix/).
...
TOOL_NAME = "list_gcs_files"



async def main():
    parser = build_argparser(TOOL_NAME, None, "List all object names under a GCS bucket path (e.g. gs://bucket/prefix/).", "Example input CSV:\n    gcsUri\n    ...\n\nExample output CSV:\n    result_field1,result_field2,...\n    value1,value2,...\n")
