...
async def main():
    parser = build_argparser(TOOL_NAME, None, "List all repositories for a workspace.", "Example input CSV:\n    workspaceId?(optional)\n    ...\n\nExample output CSV:\n    result_field1,result_field2,...\n    value1,value2,...\n")
    ...
    async with get_mcp_session(args.config) as session:
        for i, row in enumerate(rows):
            ...
            params = {
            "workspaceId": int(row["workspaceId"]) if row.get("workspaceId") else None,
            }
