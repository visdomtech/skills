...
TOOL_NAME = "check_gcs_existence"



async def main():
    parser = build_argparser(TOOL_NAME, None, "Check which GCS URIs exist and which do not.", "Example input CSV:\n    gcsUris\n    ...\n\nExample output CSV:\n    result_field1,result_field2,...\n    value1,value2,...\n")
    ...
    async with get_mcp_session(args.config) as session:
        for i, row in enumerate(rows):
            ...
            params = {
            "gcsUris": json.loads(row["gcsUris"]),
            }
