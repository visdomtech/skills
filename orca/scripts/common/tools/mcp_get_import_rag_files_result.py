#!/usr/bin/env python3
"""Poll the result of the running import_rag_files operation. Returns done=false while still in progress.
...
TOOL_NAME = "get_import_rag_files_result"



async def main():
    parser = build_argparser(TOOL_NAME, None, "Poll the result of the running import_rag_files operation. Returns done=false while still in progress.", "Example input CSV:\n    index\n    1\n\nExample output CSV:\n    result_field1,result_field2,...\n    value1,value2,...\n")
