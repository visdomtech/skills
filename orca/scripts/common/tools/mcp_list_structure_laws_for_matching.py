...
TOOL_NAME = "list_structure_laws_for_matching"



async def main():
    parser = build_argparser(TOOL_NAME, None, "List structure laws that are not yet matched to any regulation.", "Example input CSV:\n    index\n    1\n\nExample output CSV:\n    result_field1,result_field2,...\n    value1,value2,...\n")
