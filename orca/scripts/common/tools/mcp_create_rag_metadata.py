...
TOOL_NAME = "create_rag_metadata"



async def main():
    parser = build_argparser(TOOL_NAME, None, "Attach metadata to a RAG file. The key must match an existing data schema on the corpus.", "Example input CSV:\n    entries,ragFileName\n    ...,...\n\nExample output CSV:\n    result_field1,result_field2,...\n    value1,value2,...\n")
